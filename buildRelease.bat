...
REM Set the main assembly (dark_cheat.dll) location in the project bin\Release folder
set MAIN_ASSEMBLY=.\d.a.r.k. cheat\bin\Release\dark_cheat.dll

REM Set the directory where dependency DLLs are stored (in the Resources folder)
set LIB_DIR=.\d.a.r.k. cheat\Resources

REM Set the output path for the merged DLL (will be placed in bin\Release)
set OUTPUT=.\d.a.r.k. cheat\bin\Release\dark_cheat.dll
